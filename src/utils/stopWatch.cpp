...
void utils::StopWatch::setFPS(unsigned int newFPS) { frameTime = 1.0s / newFPS; }

void utils::StopWatch::printFPS(bool print) { showFPS = print; }
...
void utils::Timer::reset() { time = coolDown; }

void utils::Timer::stop() { active = false; }

void utils::Timer::start() { active = true; }

void utils::Timer::setTime(unsigned int newTime) { Timer::time = newTime; }

unsigned int utils::Timer::getCooldown() const { return coolDown; }

unsigned int utils::Timer::getTime() const { return time; }
