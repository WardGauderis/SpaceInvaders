...
utils::Assets::Assets() : music(std::make_shared<sf::Music>()), bold(std::make_shared<sf::Font>()),
                          normal(std::make_shared<sf::Font>()) {
...
const std::shared_ptr<sf::Music>& utils::Assets::getMusic() const {
	return music;
}

const std::shared_ptr<sf::Font>& utils::Assets::getBold() const {
	return bold;
}

const std::shared_ptr<sf::Font>& utils::Assets::getNormal() const {
	return normal;
}
