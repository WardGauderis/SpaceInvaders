...
bool SI::model::Entity::mayDeleteThis() const { return mustDelete; }
...
void SI::model::Entity::addModel(const std::shared_ptr<Entity>& model) { newModels.emplace_back(model); }
